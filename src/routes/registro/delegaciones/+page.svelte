...
<form bind:this={formDelegaciones} method="POST" action="https://api.smmun.com/registro/delegaciones" name="registro-delegaciones" enctype="multipart/form-data" class="col g-3" novalidate onsubmit={onSubmitForm}>
    ...
    <div class="mb-3">
        ...
        <div>
            ...
            <input oninput={onChangeComprobante} class="form-control focus-ring focus-ring-danger" required autocomplete="off" name="comprobante" type="file" id="input-comprobante" accept={COMPROBANTE_ACCEPT}>
