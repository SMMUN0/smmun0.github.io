...
<!-- Forms -->
<form bind:this={formFaculty} method="POST" action="https://rlmmun-inscripciones-endpoint-otqml.ondigitalocean.app/registro/faculty" name="registro-faculty" enctype="multipart/form-data" class="col g-3" novalidate onsubmit={onSubmitForm}>
