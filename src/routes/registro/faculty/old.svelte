...
<!-- Forms -->
<form bind:this={formFaculty} method="POST" action="https://jellyfish-app-iyb7k.ondigitalocean.app/api/registro/faculty" name="registro-faculty" enctype="multipart/form-data" class="col g-3" novalidate onsubmit={onSubmitForm}>
    ...
    <div class="mb-3">
        ...
        <div class="row g-3">
            <div class="col">
                <input oninput={onChangeSaveCookie} class="form-control" required autocomplete="off" name="nombre_faculty" placeholder="Nombre(s)" type="text" maxlength="150">
                <div class="invalid-feedback">Debes llenar este campo.</div>
            </div>
            <div class="col">
                <input oninput={onChangeSaveCookie} class="form-control" required autocomplete="off" name="apellido_faculty" placeholder="Apellidos" type="text" maxlength="150">
                <div class="invalid-feedback">Debes llenar este campo.</div>
            </div>
        </div>
        ...
        <div>
            ...
            <input oninput={onChangeSaveCookie} use:intlPhone class="form-control" name="celular_faculty" data-name="celular_faculty" required autocomplete="off" placeholder="999 123 4567" type="tel" maxlength="30">
        </div>

        <div>
            <label for="correo_faculty" class="form-label">Correo electrónico <span style="color: red;">*</span></label>
            <input oninput={(ev) => onChangeCorreo(ev)} class="form-control input-correo" required autocomplete="off" name="correo_faculty" placeholder="ejemplo@dominio.com" type="email" maxlength="150" class:is-invalid={!correoValidity}>
        ...
        <div class="row g-3">
            ...
            <div class="col">
                <input oninput={onChangeSaveCookie} class="form-control" required autocomplete="off" name="ciudad_estado_faculty" placeholder="Ciudad y estado" type="text" maxlength="150">
                <div class="invalid-feedback">Debes llenar este campo.</div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-3">
        <div>
            ...
            <input oninput={onChangeSaveCookie} class="form-control" required autocomplete="off" name="institucion_delegacion_oficial" placeholder="Ejemplo: Facultad de Derecho UADY" type="text" maxlength="88">
            <div class="invalid-feedback">Debes llenar este campo.</div>
        </div>
        ...
        <div>
            ...
            <input oninput={onChangeNumeroDelegaciones} class="form-control" required autocomplete="off" name="numero_delegaciones" placeholder="Mínimo 4 personas" type="text" maxlength="2" inputmode="numeric" bind:value={numeroDelegacionesValue} class:is-invalid={!numeroDelegacionesValidity}>
    ...
    {#if numeroDelegacionesValidity}
        <article>
            {#each { length: parseInt(numeroDelegacionesValue!) }, i}
    ...
    <div class="mb-3">
        ...
        <ol style="text-align: justify; line-height: 1.6rem;">
            ...
            Adjunto a este comprobante existira una imagen con el logo de su institución y un formato específico del SMMUN 2025 que nos asegura que nosotros hemos compartido dicha imagen.</li>
    ...
    <div class="mb-3" id="aceptar-reglamento">
        <div class="form-check">
            ...
            <label for="aceptar-reglamento" class="form-check-label">He leído, comprendido y aceptado las condiciones del Modelo de Naciones Unidas del Sureste Mexicano (SMMUN) 2025: Legado de Líderes.</label>
