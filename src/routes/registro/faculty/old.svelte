...
<!-- Forms -->
<form bind:this={formFaculty} method="POST" action="/api/registro/faculty" name="registro-faculty" enctype="multipart/form-data" class="col g-3" novalidate onsubmit={onSubmitForm}>
    <!-- Descripción -->
    <div class="mb-3">
        <p style="text-align: justify;">
            El RLM-MUN es el <b>Modelo de Naciones Unidas de la Escuela Secundaria Ricardo López Méndez</b>. La segunda edición se llevará a cabo el <b>sábado 4 de octubre de 2025</b>, de <b>8:00 a 17:00 horas</b>, en las instalaciones de la propia secundaria, ubicada en la ciudad de <b>Valladolid, Yucatán</b>.
            <br><br>
            Esta actividad está dirigida a estudiantes de entre 11 y 26 años de edad, provenientes principalmente de la zona oriente del estado, interesados en el debate, la diplomacia y el aprendizaje sobre temas internacionales.
        </p>
    </div>
    ...
    <div class="mb-3">
        ...
        <p style="text-align: justify;">
            <i>
                ¡Hola! Agradecemos mucho la confianza de parte de su equipo para ser parte de la experiencia del RLM-MUN 2025. Ser Faculty involucra una responsabilidad y esperamos que las instrucciones sean lo más claras posibles, buscando solicitar su apoyo para seguirlas como se especifican. Sin embargo, si existen dudas, por favor no dude en contactarnos.
            </i>
        </p>
        ...
        <ol style="text-align: justify; line-height: 1.6rem;">
            ...
            Adjunto a este comprobante existira una imagen con el logo de su institución y un formato específico del RLM-MUN 2025 que nos asegura que nosotros hemos compartido dicha imagen.</li>
        ...
        {#if numeroDelegacionesValidity}
            <p>
                <strong>Costo total de inscripción:</strong> {(70 * parseInt(numeroDelegacionesValue!)).toLocaleString()} MXN ($70 MXN por {numeroDelegacionesValue} personas)
            </p>
        {/if}

        <div>
            <label for="comprobante" class="form-label">Suba el comprobante de pago (máx 5 MB)<span style="color: red;">*</span></label>
            <input oninput={onChangeComprobante} class="form-control focus-ring focus-ring-danger" required autocomplete="off" name="comprobante" type="file" accept="image/*,.pdf">
    ...
    <div class="mb-3" style="line-height: 1.6rem; text-align: justify;">
        Se recuerda que cada Faculty Advisor es responsable de los términos estipulados en el presente documento, el cual debe ser de conocimiento por todas aquellas personas responsables del cargo que se encuentren registradas en el Modelo de Naciones Unidas de la Secundaria Ricardo López Méndez (RLM-MUN).
        <br><br>
        Nuestro objetivo es trabajar de la mano para hacer cumplir las reglas y regulaciones del evento, y en caso de su violación por parte de las delegaciones, el RLM-MUN se encargará de estipular las sanciones e informárselas a los responsables académicos correspondientes. Por lo tanto, las personas Faculty son responsables de supervisar a sus delegaciones en todo momento y de asegurarse de que sigan las reglas del MUN, incluidas, entre otras, las descritas en los puntos anteriores.
        <br><br>
        ...
        <br><br>
        - Todas las personas Faculty Advisor deben tener un número de celular en funcionamiento registrado en el RLM-MUN durante el Modelo.
        <br><br>
        - Las Faculty deben asegurarse de estar accesibles por teléfono en todo momento durante la conferencia, para casos como el informe por mal comportamiento de las delegaciones o para ayudar al personal del RLM-MUN a localizarles en casos de emergencia.
        <br><br>
        ...
        <div class="accordion">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        ...
                        <ul style="margin: 1rem 0;">
                            <li>Delegación (Individual): $80.00 MX (OCHENTA PESOS MEXICANOS)</li>
                            <li>Formar parte de una Delegación Oficial (Mínimo 4 personas): $70.00 MX por persona (SETENTA PESOS MEXICANOS)</li>
                        </ul>
                        Esto incluye diferentes beneficios como: seguimiento por parte de Secretaría de Vinculación correspondiente, previo y durante el Modelo, acceso a la inauguración y clausura del evento, coffee break y más sorpresas.
                        <br><br>
                        <strong>Nota importante:</strong> TODAS las delegaciones deben realizar su inscripción individual POSTERIOR al envío de este formulario. La razón de esto es para que el RLM-MUN pueda cotejar los pagos con la información otorgada tanto por la persona Faculty Advisor como por la delegación, en caso de existir una contradicción, el equipo RLM-MUN se encargará de contactarse con usted. Por otro lado, las delegaciones deberán adjuntar como comprobante de pago la IMAGEN que será enviada por la Secretaría de Finanzas al correo que usted registró.
                        <br><br>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        La organización RLM-MUN 2025 está comprometida con la promoción de la equidad y la inclusión en el MUN. Nuestro objetivo es alentar a personas de diversos orígenes y experiencias variadas a reunirse y participar en debates claves sobre temas críticos. RLM-MUN prohíbe estrictamente cualquier forma de discriminación o prejuicio basado en sexo, género, identidad de género, orientación sexual, discapacidad, edad, religión, etnia, raza, estatus socioeconómico o cualquier otro factor que pueda obstaculizar nuestro compromiso con la equidad.
                        <br><br>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        Al inscribirse en el RLM-MUN 2025, usted y/o su delegación oficial (en adelante, "la Delegación Participante") otorgan su consentimiento expreso para que el equipo de comunicación del RLM-MUN capture y utilice imágenes y videos del evento, incluyendo pero sin limitarse a fotografías y grabaciones de video que puedan incluir al Participante.
                        <br><br>
                        La Delegación Participante reconoce y acepta que dichas imágenes y videos pueden ser utilizados por el RLM-MUN en sus sitios web, materiales promocionales y otros medios de comunicación, con fines de divulgación y promoción del evento.
                        <br><br>
                        Al aceptar este consentimiento, la Delegación Participante:
                        <ol style="margin: 1rem 0;">
                            <li>Reconoce haber leído y entendido la política de uso de imagen y derechos de publicación del RLM-MUN.</li>
                            <li>Otorga su consentimiento expreso para el uso de su imagen y voz en los términos descritos anteriormente.</li>
                            <li>Renuncia a cualquier reclamación o derecho que pueda tener respecto al uso de su imagen y voz por parte del RLM-MUN.</li>
                        </ol>
                ...
                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        ...
                        <ol style="margin: 1rem 0;" type="I">
                            ...
                            <br>
                            <li><strong>Comunicación de necesidades y peticiones.</strong> Para cualquier petición, requerimiento o necesidad de sus delegaciones, el Faculty Advisor deberá comunicarlo siempre con la Comisión o alguna otra persona del Comité Organizador, dependiendo de la situación o el asunto.</li>
                            <br>
                            ...
                            <br>
                            <li><strong>Asesoría en protocolos.</strong> Ayudan a sus delegaciones a comprender y prepararse para las reglas de procedimiento, mociones y el flujo general del debate en el Modelo. De igual forma, cualquier Faculty Advisor podrá acercarse a la Comisión del RLM-MUN para resolver dudas o comentarios respecto al protocolo y/o funcionamiento interno de cada comité.</li>
                            <br>
                            <li><strong>Mantener el respeto.</strong> Independiente de cualquier situación, el Faculty Advisor deberá mantener respeto hacia cualquier persona integrante del RLM-MUN, incluyendo delegaciones que no integran su Delegación Oficial; todas las Mesas Directivas, sin importar si estas son o no Mesas de sus delegaciones; todas las personas del Comité Organizador; todas las personas que se desempeñan como Faculty Advisors y el personal académico, administrativo y manual de las instalaciones donde se llevará a cabo el RLM-MUN.</li>
                            <br>
                            <li><strong>Apertura al diálogo.</strong> La Comisión del RLM-MUN siempre estará dispuesta a escuchar recomendaciones, sugerencias y comentarios sobre cualquier situación, por lo que se le exhorta al Faculty Advisor de tener la confianza de acercarse siempre que lo desee a externar sus dudas y comentarios.</li>
                        </ol>

                        <strong>SOBRE SUS LIMITACIONES ACADÉMICAS DENTRO DEL RLM-MUN:</strong>
                        <br>
                        <i>(Estas limitaciones solo son requeridas dentro de los horarios e instalaciones donde se llevará a cabo el RLM-MUN, considerando que cada Faculty Advisor tiene libertad académica de acuerdo a los propios lineamientos de su escuela u organización del cual forma parte)</i>
                        <ol style="margin: 1rem 0;" type="I">
                            ...
                            <br>
                            <li><strong>Hablar con las Mesas Directivas.</strong> Para asuntos académicos, protocolarios o logísticos, queda estrictamente prohibido realizar cualquier petición, requerimiento o necesidad de sus delegaciones de forma oral o escrita en cualquier medio con alguna persona integrante de las Mesas Directivas, ya sea fuera o dentro de la inauguración, capacitaciones y/o sesiones de debate. En caso de ser necesario, el Faculty Advisor deberá de comunicarse primero con la Comisión del RLM-MUN y estas serán las encargadas de transmitir el mensaje con la Mesa Directiva.
                            <br><br>
                            Cualquier corrección o sugerencia sobre el protocolo debe ser canalizada únicamente a la Comisión del RLM-MUN, evitando interacciones directas con la Mesa Directiva.</li>
                            <br>
                            <li><strong>Influenciar las decisiones de la Mesa Directiva.</strong> No tienen autoridad para intervenir en las decisiones de ninguna de las personas integrantes de la Mesa Directiva (Presidencia, Moderación, Oficialía de Conferencias y Oficialías de Sala) ni para opinar sobre el desempeño o decisiones tomadas en el comité.</li>
                            <br>
                        ...
                        <ol style="margin: 1rem 0;" type="I">
                            ...
                            <br>
                            <li><strong>Prohibición de ingreso a sesiones de caucus inmoderados.</strong> Los Faculty Advisors no pueden ingresar a los caucus inmoderados a menos que sea una emergencia o la Comisión del RLM-MUN les haya otorgado permiso de entrada mediante una solicitud previa.
                            <br><br>
                            ...
                            <br>
                            <li><strong>Proceso de espera del comité donde la Presidencia se retira de la sala para llevar a la aprobación del documento resolutivo a la Comisión del RLM-MUN.</strong> Durante esta etapa queda estrictamente prohibido entrar o mantenerse durante la sala, por cualquier motivo o circunstancia.
                            <br><br>
    ...
    <div class="mb-3" id="aceptar-reglamento">
        <div class="form-check">
            ...
            <label for="aceptar-reglamento" class="form-check-label">He leído, comprendido y aceptado las condiciones del RLM-MUN 2025.</label>
